...
const es: Record<TranslationKey, string> = {
  ...
  "tasks.group.parked": "⏸️ Fuera de cola",
  ...
  "tasks.status.sem_dono": "Sin dueño",
  "tasks.status.backlog": "Backlog",
  "tasks.status.epic": "Epic",
  "tasks.status.parked": "Fuera de cola",
  ...
  "tasks.facet.parked": "Fuera de cola",
  "tasks.facet.sem_dono": "Sin dueño",
  "tasks.facet.done": "Completada (cerrada)",
  ...
  "tasks.parkedNoPlay": "Aparcada por el CEO — fuera de la cola, sin Play",
  "tasks.playConfirm":
  ...
  "tasks.playClosed": "#{n} ya está cerrada",
