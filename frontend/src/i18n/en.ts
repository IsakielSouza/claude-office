const en = {
  ...
  "tasks.status.sem_dono": "No owner",
  "tasks.status.backlog": "Backlog",
  "tasks.status.epic": "Epic",
  "tasks.status.parked": "Parked",
  ...
  "tasks.facet.parked": "Parked (out of queue)",
  "tasks.facet.sem_dono": "No owner",
  "tasks.facet.done": "Done (closed)",
  ...
  "tasks.parkedNoPlay": "Parked by the CEO — out of the queue, no Play",
  "tasks.playConfirm":
  ...
  "tasks.playClosed": "#{n} is already closed",
